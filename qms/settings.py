...
SECRET_KEY = 'django-insecure-^53v@-19ji&%+h@78vpkns@iu#$bevcsz_hnz(9i5ne*cci*2_'
...
JAZZMIN_SETTINGS = {
    ...
    "login_logo": "assets/img/slogan_logo.png",
    ...
    "welcome_sign": "Welcome to the CYBUS",
    ...
    "order_with_respect_to": ["auth", "system", "books.author", "books.book"],
